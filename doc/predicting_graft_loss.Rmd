...
__Table 3:__ Predicted risk for graft loss or mortality at 1 year following transplant according to the final prediction model from the current analysis.
`r fp_par(line_spacing = 1)`
`r tbl_partial$table`
\newpage
